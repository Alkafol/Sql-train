...
function TrainPage(props) {
    ...
    function getAllTasks() {
        ...
        axios.get(process.env.REACT_APP_BACKEND_URL + "/getAllTasks/" + props.databaseName).then(res => {
            let data = res.data
    ...
    async function getTaskSolution(taskId) {
        if (!currentTaskSolution) {
            axios.get(process.env.REACT_APP_BACKEND_URL + "/getSolution/" + taskId).then(res => {
    ...
    return (
        <div className="App">
            <div className="first_column">
                <TableStructure description={props.tableStructure}/>
